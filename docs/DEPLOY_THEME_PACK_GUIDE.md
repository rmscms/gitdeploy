...
| `deploy.editor` | WebView2 / Monaco / AvalonEdit / SQL completion & syntax (`tabClose` / `tabCloseOnAccent` for editor tab close icons; `actionActive*` for armed toolbar icons) |
